...
const COLUMNS = [
  ...
  { key: "seriesZh", header: "大系列（中文）", width: 14 },
  { key: "seriesName", header: "大系列（原文）", width: 26 },
  { key: "seriesId", header: "系列代碼", width: 10, text: true },
  { key: "setName", header: "卡包／擴充包名稱", width: 26 },
  { key: "setKey", header: "卡包 ID", width: 14, text: true },
  { key: "setId", header: "卡包代碼", width: 12, text: true },
  { key: "cardNumber", header: "完整卡號", width: 13, text: true },
  { key: "regulationMark", header: "規則標記", width: 11, text: true },
  { key: "fieldSource", header: "系列／卡包／標記依據", width: 20 },
